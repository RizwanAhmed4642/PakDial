...
{
    public class CustomerListingsSummary : ViewComponent
    {
        #region Prop
        ...
        public CustomerListingsSummary(IHomeListingService IHomeListingService)
        {
        ...
        {
            return View(_IHomeListingService.GetClientSummaryResults(CustomerId));
        }
        #endregion
    }
}
