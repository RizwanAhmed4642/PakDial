...
{
    public class CompanyListingAddress :ViewComponent
    {
        #region Prop
        ...
        #region Ctor
        public CompanyListingAddress(IHomeListingService IHomeListingService)
        {
         ...
         public async Task<IViewComponentResult> InvokeAsync( decimal ListingId)
        {
            ...
            return View(_IHomeListingService. GetAddress(ListingId));
        }
        #endregion
    }
}
