...
{
    public class CompanyListingContact :ViewComponent
    {
        #region Prop
        ...
        public CompanyListingContact(IHomeListingService IHomeListingService)
        {
        ...
        {
            return View(_IHomeListingService.GetContactNo(ListingId));
        }
        #endregion
    }
}
