...
{
    public class CompanyListingEmailSite : ViewComponent
    {
        #region Prop
        ...
        #region Ctor
        public CompanyListingEmailSite(IHomeListingService IHomeListingService)
        {
        ...
        {
            return View(_IHomeListingService.GetcompanyListbyId(ListingId));
        }
        #endregion
    }
}
