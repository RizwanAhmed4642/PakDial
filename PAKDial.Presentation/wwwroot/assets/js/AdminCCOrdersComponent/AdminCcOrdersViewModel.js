$(function () {
    ...
    $('#AdminCcOrder').DataTable({
        ...
        "order": [[0, "desc"]],
        ajax: {
            url: "/AdminCCOrders/LoadCcOrders",
            type: "POST",
            datatype: "json",
        ...
        columnDefs: [
            ...
            { "width": "5%", "targets": 8 },
            {
                ...
                render: function (data, type, full, meta) {
                    var Id = full.id;
                    var Invoice = '<button id="CcOrderGenrateInv" value=' + Id + ' type="button" class="btn mr-1 mb-1 btn-primary btn-sm">&nbsp;Invoice&nbsp;</button>'
                    return '<td> ' + Invoice + ' </td>'
                }
            }
        ],
    ...
    $("#AdminCcOrder").on('click', '#CcOrderGenrateInv', function () {
        var invoiceNo = $(this).val();
        window.location.href = "/AdminCCOrders/SaleCcReport?InvoiceId=" + invoiceNo
    });
