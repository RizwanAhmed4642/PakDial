...
$("#AddCompanyListings_Submit_Form").validate({
    ...
    submitHandler: function (form) {
        ...
        //    if ($("#ACLstListingType").val() == "" &&
        //        $("#ACLstCompanyName").val() == "" &&
        //        $("#ACLstFirstName").val() == "" &&
        //        $("#ACLstLastName").val() == "" &&
        //        $("#ACLstMobileNumber").val() == "" &&
        //        ($("#ACLstMobileNumber1").val() == "" || $("#ACLstMobileNumber1").val() == undefined) &&
        //        $("#ACLstEmail").val() == "" &&
        //        $("#ACLstPassword").val() == "") {
        //        $("#ACcompanyDetail").addClass("show");
        //    }
        //    else {
        //        $("#ACcompanyDetail").removeClass("show");
        //    }
        //}
        //else {

        //    if ($("#ACLstCustomer").val() == "" &&
        //        $("#ACLstListingType").val() == "" &&
        //        $("#ACLstCompanyName").val() == "" &&
        //        $("#ACLstFirstName").val() == "" &&
        //        $("#ACLstLastName").val() == "" &&
        //        $("#ACLstMobileNumber").val() == "" && $("#ACLstMobileNumber1").val() == "") {
        //        $("#ACcompanyDetail").addClass("show");
        //    }
        //    else {
        //        $("#ACcompanyDetail").removeClass("show");
        ...
        //}
        //if ($("#ACLstState").val() == "" &&
        //    $("#ACLstCity").val() == "" || $("#ACLstCity").val() == null &&
        //    $("#ACLstCityArea").val() == "" || $("#ACLstCityArea").val() == null) {
        //    $("#ACLocationInformation").addClass("show");
        //}
        //else {
        //    $("#ACLocationInformation").removeClass("show");
        //}
        ...
        $.ajax({
            url: "/AdminCompanyListings/AddCompanyListing",
            type: "post",
            datatype: "json",
