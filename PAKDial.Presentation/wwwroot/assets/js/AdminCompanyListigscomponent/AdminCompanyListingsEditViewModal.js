...
$(document).ready(function () {
    ...
    $.ajax({
        url: "/AdminCompanyListings/LoadAddCompanyListingList",
        type: "get",
        datatype: "json",
        async: false,
   ...
   // $("#UCLstCity").select2({ placeholder: "Please Select" });
    ...
    $("#UCLstPaymentsModes").select2({
        ...
        ajax: {
            url: "/AdminCompanyListings/LoadPaymentModeList",
            dataType: 'json',
            delay: 250,
            type: "get",
            async: false,
    ...
    $("#UCLstServicetypes").select2({
        placeholder: "Please Select",
        ajax: {
            url: "/AdminCompanyListings/LoadTypeofServiceList",
            dataType: 'json',
            delay: 250,
            type: "get",
            async: false,
    ...
    if (Id != "" && Id != null) {
        ...
        $.ajax({
            url: "/AdminCompanyListings/GetCompanyListingsById",
            type: "get",
            datatype: "json",
            data: { Id: Id },
            async: false,
                ...
                if (response != null) {
                    ...
                    if (response.listingLandlineNo.length != 0) {
                     ...
                     if (response.listingMobileNo.length > 1) {
                        ...
                        $("#UAddMobileNumber").append('<div class="input-group form-col form-spn-minus" data-repeater-item="" style="" id="RemovedivMobileNumber"><input type="text" placeholder="+92 000 000" class="form-control" id="UCLstMobileNumber1" maxlength="11" style="border: 1px solid rgb(194, 202, 216); background-color: white;" aria-invalid="false"><span class="input-group-append" id="button-addon2"><button class="btn btn-add-field-lst" id="RemoveMobileNo" onclick="RemoveMobNo()"  type="button" data-repeater-delete=""><i class="fa fa-minus"></i></button> </span></div>')
                               
                        $("#UCLstMobileNumber1").val(response.listingMobileNo[1].mobileNo);
                    }
                    if (response.listingLandlineNo.length > 1) {
                        $("#UAddLandNumber").append('<div class="input-group form-col form-spn-minus" data-repeater-item="" style="" id="RemovedivLandLine" > <input type="text" placeholder="0423-000000" class="form-control" id="UCLstLandLineNumber1" maxlength="12" style="border: 1px solid rgb(194, 202, 216); background-color: white;" aria-invalid="false"><span class="input-group-append" id="button"><button class="btn btn-danger" id="RemoveLandNo"  onclick="RemoveLandLineNo()"  type="button" data-repeater-delete=""> <i class="fa fa-minus" id="test"></i></button></span></div>')
                    ...
                    if (response.listingAddress.stateId > 0) {
                        ...
                        var id = response.listingAddress.cityAreaId;

                        var text = response.listingAddress.cityAreaName;
                        //$("#UCLstCityArea").find('option[value="' + response.listingAddress.cityAreaId + '"]').attr('selected', 'selected');
                   
                        var newOptionarea = new Option(text, id, true, true);
                      
                        $('#UCLstCityArea').append(newOptionarea).trigger('change');
                    }
...
$("#EditCompanyListings_Submit_Form").validate({
    ...
    errorPlacement: function (error, element) {
        ...
        if (name == "MobileNumber") {
            ...
            if (name != "MobileNumber"  && name != "RemovedivMobileNumber" ) {
    ...
    submitHandler: function (form) {
        ...
        //if ($("#UCLstListingType").val() == "" &&
        //    $("#UCLstCompanyName").val() == "" &&
        //    $("#UCLstFirstName").val() == "" &&
        //    $("#UCLstLastName").val() == "" &&
        //    $("#UCLstMobileNumber").val() == "" && ($("#UCLstMobileNumber1").val() == "" || $("#UCLstMobileNumber1").val() == undefined)) {
        //    $("#UACcompanyDetail").addClass("show");
        //}
        //else {
        //    $("#UACcompanyDetail").removeClass("show");
        //}

        //if ($("#UCLstState").val() == "" &&
        //    $("#UCLstCity").val() == "" || $("#UCLstCity").val() == null &&
        //    $("#UCLstCityArea").val() == "" || $("#UCLstCityArea").val() == null) {
        //    $("#UACLocationInfo").addClass("show");
        //}
        //else {
        //    $("#UACLocationInfo").removeClass("show");
        //}
        ...
        $.ajax({
            url: "/AdminCompanyListings/EditCompanyListing",
            type: "post",
            datatype: "json",
            ...
            success: function (response) {
                ...
                if (response.error == "403") {
                    ...
                    if (Sfile.length > 0) {
                        $.ajax({
                            url: "/AdminCompanyListings/UpdateBannerImage?Id=" + response,
                            type: "post",
                            datatype: "json",
                            data: Sdata,
                            async: false,
                    ...
                    if (Mfile.length > 0) {
                        $.ajax({
                            url: "/AdminCompanyListings/UpdateGalleryBannerImage?Id=" + response,
                            type: "post",
                            datatype: "json",
                            data: Mdata,
                            async: false,
...
function GetButtonValue() {
    if (btnCLSave == "UpdateNew") {
        $("#MainSection").hide();
        ResetCompanyListings();
        toastr.success("Company Listings Updated Successfully", "Success");
        //$("#AddCompanyListings_Submit_Form").trigger("reset");
       
        window.location.href = "/AdminCompanyListings/AddCompanyListing";
        
    }
    else if (btnCLSave == "UpdateClose") {
        $("#MainSection").hide();
        toastr.success("Company Listings Updated Successfully", "Success");
        window.location.href = "/AdminCompanyListings/Index";
        ResetCompanyListings();
    }
}
...
$("#btnAddMobile").click(function () {
    ...
    $("#UAddMobileNumber").append('<div class="input-group form-col form-spn-minus" data-repeater-item="" style="" id="RemovedivMobileNumber"><input type="text" placeholder="+92 000 000" class="form-control"  name="UCLstMobileNumber1" id="UCLstMobileNumber1" maxlength="11" style="border: 1px solid rgb(194, 202, 216); background-color: white;" aria-invalid="false"><span class="input-group-append" id="button-addon2"><button class="btn btn-danger" id="RemoveMobileNo" onclick="RemoveMobNo()"  type="button" data-repeater-delete=""><i class="fa fa-minus"></i></button> </span></div>')
...
$("#btnAddLandNo").click(function () {
    ...
    $("#UAddLandNumber").append('<div class="input-group form-col form-spn-minus" data-repeater-item="" style="" id="RemovedivLandLine" > <input type="text" placeholder="0423-000000" class="form-control" name="UCLstLandLineNumber1" id="UCLstLandLineNumber1" maxlength="11" style="border: 1px solid rgb(194, 202, 216); background-color: white;" aria-invalid="false"><span class="input-group-append" id="button"><button class="btn btn-add-field-lst" id="RemoveLandNo"  onclick="RemoveLandLineNo()"  type="button" data-repeater-delete=""> <i class="fa fa-minus" id="test"></i></button></span></div>')
...
function RemoveBannerImage() {
    ...
    var Sdata = getSelectedImages($('#Uimagefiles'));
    $.ajax({
        url: "/AdminCompanyListings/DeleteBannerImage?Id=" + $("#ECompanyListingId").val(),
        type: "post",
        datatype: "json",
        data: Sdata,
        async: false,
    ...
    if (window.File && window.FileList && window.FileReader) {
        ...
        for (var i = 0; i < files.length; i++) {
            ...
            picReader.addEventListener("load", function (event) {
                ...
                div.innerHTML = '<div class="parent"><img class="img - thumbnail img - fluid"  itemprop="thumbnail" alt="Image description" value="' + Value + '"  id="' + Id + '" style="width:270px; height:138px;" /><button class="close" id="btnRemoveImage' + Value + '" onclick="RemoveImage(' + Id + ')">x</button></div></figure > &nbsp;&nbsp;';
...
$("#UCLstState").change(function () {
    ...
    if ($("#UCLstState").val() > 0) {
        ...
        $.ajax({
            url: "/AdminCompanyListings/GetCityListById",
            dataType: 'json',
            delay: 250,
            type: "get",
...
$("#UCLstCity").change(function () {
    ...
    if ($("#UCLstCity").val() > 0) {
        ...
        $("#UCLstCityArea").select2({
            placeholder: "Please Select",
            ajax: {
                url: "/AdminCompanyListings/GetCityAreaByCityId",
                dataType: 'json',
                delay: 250,
                type: "get",
                async: false,
...
//        $.ajax({
//            url: "/AdminCompanyListings/GetCityAreaById",
//            dataType: 'json',
//            delay: 250,
//            type: "get",
...
$("#UCLstCategory").change(function () {
    ...
    if ($("#UCLstCategory").val() > 0) {
        ...
        $("#UCLstSubCategory").select2({
            placeholder: "Please Select",
            ajax: {
                url: "/AdminCompanyListings/LoadAddSubMenuCategories",
                dataType: 'json',
                delay: 250,
                type: "get",
                async: false,
...
$('#UCLstBusinessTypes').select2({
    placeholder: "Please Select",
    ajax: {
        url: '/AdminCompanyListings/LoadBussinessType',
        dataType: 'json',
        delay: 250,
        type: "get",
        async: false,
...
function RemoveImage(Id) {
    ...
    if (x == true) {
        ...
        if (check == false) {
            $.ajax({
                url: "/AdminCompanyListings/DeleteGalleryImage",
                type: "Get",
                datatype: "json",
                async: false,
