...
{
    public class SeOrderReportResponse
    {
        public SeOrderReportResponse()
        {
            OrderTracking = new List<SpGetSeOrderTracking>();
            EmailPhone = new SpGetEmailAndPhoneByOrderId();
            SEOrderDetails = new List<SpGetSeOrderDetailByOrderId>();
        }
        ...
        public List<SpGetSeOrderDetailByOrderId> SEOrderDetails { get; set; }
    }
}
